...
--[[Translation missing --]]
Gnosis.L["OptCBChannelColor"] = "Castbar color (channeled)"
...
--[[Translation missing --]]
Gnosis.L["OptCBEnRC"] = "Enable range indication"
Gnosis.L["OptCBEnRCDesc"] = "Farbe ändern, wenn das Ziel außer Reichweite gerät (nur Spieler-Zauberleiste)"
...
--[[Translation missing --]]
Gnosis.L["OptCBRangeColor"] = "Out of range color"
...
Gnosis.L["OptCBEnRC"] = "Enable range indication"
--[[Translation missing --]]
Gnosis.L["OptCBEnRCDesc"] = "Change color when the player's target gets out of range (player castbars only)"
...
Gnosis.L["MsgUnregGlobalMouse"] = "不註冊全局滑鼠事件（請參閱 GUI 選項）"
Gnosis.L["MsgUnregGlobalMouseNotReq"] = "全局滑鼠事件已取消註冊（請參閱 GUI 選項）"
Gnosis.L["No"] = "否"
...
Gnosis.L["OptUnregGlobalMouse"] = "取消註冊全局滑鼠事件（例如，允許“貼上導入連結到聊天”；禁用取消註冊需要重載UI）"
Gnosis.L["OptWfCL_Desc"] = "Delay output/clip test after output/clip test request for given time in ms to account for possible combat log delay."
...
Gnosis.L["MsgUnregGlobalMouse"] = "전역 마우스 이벤트 해제 (gui 옵션 확인)"
Gnosis.L["MsgUnregGlobalMouseNotReq"] = "전역 마우스 이벤트가 이미 해제되었습니다 (gui 옵션 확인)"
Gnosis.L["No"] = "아니오"
...
Gnosis.L["OptClipWarn_Name"] = "클립 경고 [ms]"
...
Gnosis.L["OptConfLoadCT"] = "전투문자/클립 테스트 설정 불러오기"
...
Gnosis.L["OptConfStoreCT"] = "전투문자/클립 테스트 설정 저장"
...
Gnosis.L["OptCSFSClip"] = "글꼴 크기 (클립, 0=기본)"
Gnosis.L["OptCSFSNonClip"] = "글꼴 크기 (비-클립, 0=기본)"
...
Gnosis.L["OptEnClipTest"] = "클립 테스트 사용"
...
dmg: 정신 집중 주문의 피해량이나 치유량
eh: 유효 치유량 (=치유량-초과 치유량)
oh: 초과 치유
dps: 정신 집중 주문의 dps나 hps
target: 정신 집중 대상의 이름
clipped: 의도하지 않은 클립 발생 여부 정보
cliptext<문자>: 필요 시 클립 발생 정보를 대체하는 문자열
...
Gnosis.L["OptUnregGlobalMouse"] = "전역 마우스 이벤트 해제 (예. \"대화에 가져오기 링크 붙여넣기\" 허용; 해제 비활성은 UI를 다시 불러와야 합니다)"
Gnosis.L["OptWfCL_Desc"] = "실제 전투 기록 지연을 반영하기 위해 출력/클립 테스트 요청 후에 ms 단위로 주어진 시간만큼 출력/클립 테스트를 지연시킵니다."
...
Gnosis.L["TabCTClipTest"] = "전투문자/클립 테스트"
